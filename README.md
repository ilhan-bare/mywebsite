...
across the semester: Part 1 covers initiation, planning, content and basic HTML structure; Part 2
will add styling and responsive design; Part 3 will add interactivity and refinement.
...
- **Perfumes** (`PAGES/perfume.html`) — the Dudai fragrance catalogue.
- **Islamic Clothing** (`PAGES/islamic-clothing.html`) — abaya and thobe catalogue.
- **Enquiry** (`PAGES/enquiry.html`) — a form for visitors to ask about products or place an order.
- **Contact** (`PAGES/contact.html`) — business contact details, hours, and an embedded map.

## Design and User Experience

- **Colour Scheme:** Warm neutrals (cream, soft gold, deep maroon) to reflect the elegance of
  both fragrance and modest fashion. (Applied in Part 2.)
- **Typography:** A clean serif for headings, paired with a simple sans-serif for body text.
  (Applied in Part 2.)
- **Layout:** A single-column, image-led layout that lets the products speak for themselves, with
  a consistent header and navigation bar on every page.

## Technical Requirements

- **Languages:** HTML5 for Part 1. CSS3 and JavaScript will be introduced in Parts 2 and 3.
...
| Styling and responsive design (Part 2) | Upcoming |
| Interactivity and refinement (Part 3) | Upcoming |

## Part 1 Details

Part 1 (this submission) covers project initiation and planning: the Website Project Proposal,
content research and sourcing, and the initial set of HTML files with a working navigation
system across all six pages. Part 2 and Part 3 will follow in future submissions and will extend
this README with styling and interactivity details.
...
- **2026-08-14** — Removed dead references to a stylesheet/script (`css/style.css`,
  `js/script.js`) that do not yet exist; these will be reintroduced in Part 2.
...
- Unsplash. (n.d.). *Unsplash — free high-resolution photos*. Retrieved August 2026, from
  https://unsplash.com
